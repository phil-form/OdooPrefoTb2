...
/*
    ...
    On va d'abord devoir passer une première fois en choisissant un pivot (généralement on
    ...
    Une fois qu'on a classé ces éléments on répète l'opération sur les deux sous-tableaux,
    donc sur les éléments à sa droite, et sur les éléments à sa gauche.

    On fait ensuite cela de façon récursive jusqu'à ne plus qu'avoir un tableau d'une taille de 1.
    ...
    à la fin du tableau. Nous ne faisons donc rien, mais inversons p et ^
                 v  p                    v  p
    ...
    Nous allons donc partitionner notre tableau en deux à partir de ^
    [2, 1] et [6, 7, 5]
    ...
    7 > 6 on incrémente v, mais on ne sait plus incrémenter v donc on swap p et ^
     v  p      v  p
    [7, 6] -> [6, 7]
     ^         ^

    Nos nouvelles partitions ont une taille de 1 donc on ne sait plus les diviser.
    Nous avons donc les partitions suivantes dans cet ordre :
    [1] [2] [3] [5] [6] [7]

    Comme ces partitions sont toutes une partie d'un même tableau, nous avons donc le
